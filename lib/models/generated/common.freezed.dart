...
@JsonKey(fromJson: GroupType.parse) GroupType get type; List<Proxy> get all; String? get now;/// Mihomo `fixed`. null = type does not expose it; '' = automatic; name = pin.
 String? get fixed; bool? get hidden; String? get testUrl; String get icon; String get name;
...
@useResult
$Res call({
@JsonKey(fromJson: GroupType.parse) GroupType type, List<Proxy> all, String? now, String? fixed, bool? hidden, String? testUrl, String icon, String name
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: GroupType.parse)  GroupType type,  List<Proxy> all,  String? now,  String? fixed,  bool? hidden,  String? testUrl,  String icon,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Group() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: GroupType.parse)  GroupType type,  List<Proxy> all,  String? now,  String? fixed,  bool? hidden,  String? testUrl,  String icon,  String name)  $default,) {final _that = this;
switch (_that) {
case _Group():
return $default(_that.type,_that.all,_that.now,_that.fixed,_that.hidden,_that.testUrl,_that.icon,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: GroupType.parse)  GroupType type,  List<Proxy> all,  String? now,  String? fixed,  bool? hidden,  String? testUrl,  String icon,  String name)?  $default,) {final _that = this;
switch (_that) {
case _Group() when $default != null:
return $default(_that.type,_that.all,_that.now,_that.fixed,_that.hidden,_that.testUrl,_that.icon,_that.name);case _:
  return null;
...
class _Group implements Group {
  const _Group({@JsonKey(fromJson: GroupType.parse) required this.type, final  List<Proxy> all = const [], this.now, this.fixed, this.hidden, this.testUrl, this.icon = '', required this.name}): _all = all;
