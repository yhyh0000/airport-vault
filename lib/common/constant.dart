...
// Product branding for the Yucon-inspired multi-airport experience.
// Keep the native package/channel names stable until the first public release;
// they are coupled to the Android service and quick-settings integration.
const appName = '机场钥仓';
...
// CI injects the fork's actual owner/repository so in-app updates never point
// users back to the upstream SlClash release feed.
const repository = String.fromEnvironment(
  'APP_REPOSITORY',
  defaultValue: 'songzhengpei/Slclash',
);
...
const defaultPrimaryColor = 0xFF5B61FF;
