...
const appChangelogEntries = <AppChangelogEntry>[
  ...
  AppChangelogEntry(
    ...
    date: '2026-09-21',
    changes: [
      '清理多账号机场页面最后一条构建 lint，生成可发布 APK',
    ],
  ),
  AppChangelogEntry(
    version: 'v0.6.12',
  ...
  AppChangelogEntry(
    ...
    date: '2026-09-21',
    changes: [
      '修复宝可梦 V2Board 可选接口返回 HTTP 404/405 时无法回退的问题',
      '补充机场接口异常回退的自动化回归测试',
    ],
  ),
  AppChangelogEntry(
  ...
  AppChangelogEntry(
    ...
    date: '2026-09-21',
    changes: [
      '完成机场账户仓移动端 UI 重设计，展示绑定、订阅发现和待处理状态',
      '修复正式构建中的 changelog lint，确保 Flutter Analyze 可通过',
    ],
  ),
  AppChangelogEntry(
    version: 'v0.6.0',
  ...
  AppChangelogEntry(
    ...
    date: '2026-09-20',
    changes: [
      '完善宝可梦 8.8 兑换功能构建校验，继续修复移动端适配问题',
    ],
  ),
  AppChangelogEntry(
    version: 'v0.5.10',
